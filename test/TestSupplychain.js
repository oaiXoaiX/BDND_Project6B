...
contract('SupplyChain', function(accounts) {
    ...
    // 3rd Test
    it("Testing smart contract function bottleItem() that allows a farmer to bottle wine", async() => {
        const supplyChain = await SupplyChain.deployed()
        ...
        await supplyChain.bottleItem(upc, {from: originFarmerID})
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5], 6, 'Error: Missing or Invalid itemState')
